...
class CalendrierHeure extends Model // value true or false dans le tableau de disponibilité et si true -> afficher le commentaire, si false afficher la card en card-header
{
    ...
    protected $table = 'CalendrierHeure';
    use HasFactory;
}
