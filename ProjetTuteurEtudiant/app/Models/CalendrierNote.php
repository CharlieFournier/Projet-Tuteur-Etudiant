...
class CalendrierNote extends Model // value true or false dans le tableau de disponibilité et si true -> afficher le commentaire, si false afficher la card en card-header
{
    ...
    protected $table = 'Calendriernotes';
    use HasFactory;

    function notes(){
        return $this -> belongsTo(CalendrierJour::class);
    }
}
